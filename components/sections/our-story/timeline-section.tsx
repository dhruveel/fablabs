      ...
      <div className="max-w-300 mx-auto">
        ...
        >
          ...
          >
            <p>
              ...
              merchandise that truly connects with you. From a hoodie for your
              college squad to a T-shirt for your startup team, we believe every
              piece of apparel should tell a story, your story.
            </p>
            <p>
              Born in the textile capital of Tiruppur, FabLabs was founded in
              2012 when our founder, Vimal N., asked a simple question:
              &lsquo;Why should merchandise feel boring and generic?&rsquo;
              Since then, we&apos;ve been on a mission to change the way merch
              is created.
            </p>
            <p>
        ...
        <m.div
          ...
          style={{
            ...
            background:
              "linear-gradient(100deg, #0a64bc 5.67%, #4f9ce7 99.53%)",
          }}
          {...fadeUp(0.2)}
        >
          ...
          company, we talk to you directly, like dost. Because merch is not just
